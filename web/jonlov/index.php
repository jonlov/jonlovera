...
<body>
    <nav class="light-blue lighten-1" role="navigation">
        <div class="nav-wrapper container"><a id="logo-container" href="#" class="brand-logo">Jonathan Lovera</a>
            <ul class="right hide-on-med-and-down">
                <li><a href="/apps/hangout">Hangout App</a></li>
            </ul>
        ...
        <div class="footer-copyright">
            <div class="container">
                <span class="right black-text">
                    Made with love by <a class="blue-text" href="https://github.com/JonLovera">Jonathan Lovera</a>
                </span>
            </div>
        </div>
    </footer>
